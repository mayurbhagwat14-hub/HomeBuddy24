...
import { FiHome, FiUsers, FiBriefcase, FiUser, FiShoppingBag, FiGrid, FiFileText, FiBell, FiSettings, FiChevronDown, FiX, FiPackage, FiTrash2, FiStar } from 'react-icons/fi';
...
const AdminSidebar = ({ isOpen, onClose }) => {
      ...
      <div key={item.route} className="mb-1">
        ...
        <div
          className={`
            ...
            ${active
              ? "bg-[#008080] text-white shadow-[0_4px_15px_rgba(0,128,128,0.3)] border border-[#009999]/30"
                  ...
                  return (
                    <div
                      ...
                      className={`
                        ...
                        ${isChildActive
                          ? "bg-[#008080]/15 text-[#00cccc] font-bold border border-[#008080]/20"
  ...
  const sidebarContent = (
    <div className="h-full w-full flex flex-col bg-[#0A0F1C] border-r border-white/5 relative overflow-hidden">
      {/* Decorative gradient blur */}
      <div className="absolute top-0 right-0 w-64 h-64 bg-[#008080] opacity-10 blur-[80px] rounded-full pointer-events-none -mr-32 -mt-32"></div>

      {/* Header Section */}
      <div className="px-5 py-7 border-b border-white/5 relative z-10">
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-3 flex-1 min-w-0">
            <div
              className="w-12 h-12 rounded-[14px] flex items-center justify-center shadow-lg shadow-[#008080]/20 flex-shrink-0 border border-white/10"
              style={{
            ...
            <div className="flex-1 min-w-0">
              <h2 className="font-bold text-white text-[15px] truncate tracking-wide">
                {adminUser.name}
              </h2>
              <p className="text-[11px] text-[#008080] font-bold uppercase tracking-wider mt-0.5 truncate">
          ...
          <button
            onClick={onClose}
            className="p-2.5 bg-white/5 hover:bg-white/10 rounded-xl transition-colors flex-shrink-0 lg:hidden border border-white/5"
      ...
      {/* Navigation Menu */}
      <nav className="flex-1 overflow-y-auto p-4 scrollbar-admin lg:pb-4 relative z-10">
