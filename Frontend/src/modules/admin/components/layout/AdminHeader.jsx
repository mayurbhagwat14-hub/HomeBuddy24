...
const AdminHeader = ({ onMenuClick }) => {
  ...
  return (
    <header
      className="bg-white/80 backdrop-blur-xl fixed top-0 left-0 right-0 z-30 transition-all duration-300 lg:left-[278px] border-b border-gray-100/50 shadow-[0_4px_30px_rgba(0,0,0,0.03)]"
      style={{
