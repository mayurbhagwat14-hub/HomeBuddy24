...
const Header = memo(({
  ...
  return (
    <header
      className="sticky top-0 z-40 w-full backdrop-blur-xl bg-white/70 border-b border-white shadow-[0_8px_30px_rgba(0,0,0,0.04)]"
      style={{
            ...
            >
              ...
              >
                ...
                <svg width="0" height="0" className="absolute">
                  <linearGradient id="HomeBuddy24-bell-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                >
                  <FiBell
                    className="w-5 h-5"
                    style={{
                      stroke: count > 0 ? '#EF4444' : 'url(#HomeBuddy24-bell-gradient)',
                      strokeWidth: '2.5',
                      color: 'transparent',
                      filter: count > 0
