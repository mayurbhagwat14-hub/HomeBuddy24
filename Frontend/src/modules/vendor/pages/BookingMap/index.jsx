        ...
        <div className="flex gap-3">
          {booking?.status === 'journey_started' && (
            <button
              ...
              className="px-6 bg-teal-600 hover:bg-teal-700 text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-teal-600/30 transition-all active:scale-95"
            >
