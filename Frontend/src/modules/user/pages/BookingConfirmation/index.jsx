...
import { FiCheckCircle, FiMapPin, FiClock, FiCalendar, FiPackage, FiHome, FiArrowRight, FiLoader, FiArrowLeft, FiBell, FiXCircle } from 'react-icons/fi';
    ...
    <div className="min-h-[100dvh] pb-32 relative bg-[#F8FAFC] overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        <main className="px-4 py-6">
          ...
          {!isSearching && ['expired', 'cancelled', 'rejected', 'failed', 'timeout', 'no_vendors'].includes(booking?.status?.toLowerCase()) && (
            <div className="flex flex-col items-center justify-center mb-6">
            ...
            <div className="flex items-center gap-2 mb-4">
              <div className={`p-2 rounded-lg ${booking.paymentMethod === 'plan_benefit' ? 'bg-amber-100' : 'bg-slate-100'}`}>
                {booking.paymentMethod === 'plan_benefit' ? (
                  ...
                  <BiRupee className="w-5 h-5 text-slate-600" />
                )}
              </div>
