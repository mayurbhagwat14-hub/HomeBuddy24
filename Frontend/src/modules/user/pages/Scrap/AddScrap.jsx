  ...
  return (
    <div className="min-h-[100dvh] pb-32 relative bg-[#F8FAFC] overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        <header className="sticky top-0 z-40 backdrop-blur-xl bg-white/70 border-b border-white px-4 py-4 flex items-center gap-3 shadow-[0_8px_30px_rgba(0,0,0,0.04)]">
          <button
            onClick={() => navigate(-1)}
          ...
          <h1 className="text-xl font-extrabold text-gray-900 tracking-tight">Add Scrap Item</h1>
        </header>
