...
const UserRoutes = () => {
  ...
  return (
    <ErrorBoundary>
      {/* Main content area - pages handle their own padding to prevent gradient shadow bugs */}
      <div>
        <Suspense fallback={<LoadingFallback />}>
          <PageTransition>
            <Routes>
              ...
              <Route path="/about-HomeBuddy24" element={<ProtectedRoute userType="user"><AboutHomeBuddy24 /></ProtectedRoute>} />
