                  ...
                  {selected ? (
                    <div className="flex items-center gap-2 bg-blue-50 rounded-lg p-1 border border-blue-100">
                      ...
                      <button
                        ...
                        className="w-8 h-8 flex items-center justify-center rounded-md text-white shadow-md hover:opacity-90 active:scale-95 transition-all" style={{ background: themeColors.button }}>
        ...
        {currentStep === 3 && (
          <div className="animate-in fade-in slide-in-from-right-4">
            <div className="flex justify-between items-center mb-6">
              ...
              <button onClick={addCustomItem} className="text-white px-4 py-2 rounded-lg font-bold text-xs shadow-sm flex items-center gap-1.5 hover:opacity-90 active:scale-95 transition-all" style={{ background: themeColors.button }}>
            ...
            <div className="flex-[2] grid grid-cols-2 gap-2">
              {(isOtpSent && paymentMode === 'cash') ? (
                ...
                <button onClick={handleSendOTP} disabled={otpLoading || qrLoading} className="py-3 bg-emerald-600 text-white font-bold rounded-xl shadow-lg flex flex-col items-center justify-center gap-1 active:scale-95 transition-all disabled:opacity-50 text-[10px]">
                  <BiRupee className="w-4 h-4" /><span>Pay in Cash</span>
                </button>
              )}
              <button onClick={handleOnlinePayment} disabled={otpLoading || qrLoading} className="py-3 text-white font-bold rounded-xl shadow-lg flex flex-col items-center justify-center gap-1 active:scale-95 transition-all disabled:opacity-50 text-[10px]" style={{ background: themeColors.button }}>
