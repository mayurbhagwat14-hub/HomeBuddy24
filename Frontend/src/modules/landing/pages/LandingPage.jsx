...
const LandingPage = () => {
  ...
  const PLAY_STORE_URL = "https://play.google.com/store/search?q=HomeBuddy24&c=apps";
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
            ...
            >
              ...
              <p className="text-base sm:text-xl leading-relaxed text-gray-500 mb-8 sm:mb-10 max-w-xl font-normal">
                "Our parts. Our warranty. Your peace of mind." — {branding?.appName || 'HomeBuddy24'} uses only platform-certified genuine electronics parts for every repair.
              </p>
            ...
            >
              <div className="relative z-10 p-2 sm:p-4 bg-gray-50 rounded-[3rem] sm:rounded-[4rem] border border-gray-100 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] overflow-hidden group">
                <div className="overflow-hidden rounded-[2.5rem] sm:rounded-[3.5rem] relative aspect-[4/5] lg:aspect-square">
                  <img src="/hero-image.png" alt="HomeBuddy24 Pro Electronics" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" />
                ...
                >
                  <div className="flex items-center gap-3 sm:gap-4 text-white">
                     ...
                     <div>
                        <p className="text-[9px] sm:text-[10px] text-gray-400 font-normal leading-none mb-1">{branding?.appName || 'HomeBuddy24'} Certified</p>
        ...
        <div className="container mx-auto px-4 sm:px-8 max-w-7xl text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                {[
                    ...
                    { title: "Doorstep Billing", desc: "Verified invoices generated at home. Transparency in every charge.", icon: <FaFileInvoice />, bg: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?auto=format&fit=crop&q=80&w=800" },
                    { title: "Platform Warranty", desc: `6-month warranty on every certified ${branding?.appName || 'HomeBuddy24'} spare part replaced.`, icon: <FaShieldAlt />, bg: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&q=80&w=800" },
                    ...
                    <motion.div 
                      ...
                      className="group relative p-8 sm:p-10 rounded-[3rem] sm:rounded-[4rem] overflow-hidden transition-all duration-700 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.3)] hover:-translate-y-4 h-[350px] sm:h-[400px] flex flex-col justify-end text-left border border-gray-100"
                    >
        ...
        <div className="container mx-auto px-4 sm:px-8 max-w-7xl relative z-10 text-center lg:text-left">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 sm:gap-20 mb-12 sm:mb-20 border-b border-white/5 pb-12 sm:pb-20">
            ...
            <div className="hidden sm:block text-nowrap">
              ...
              <ul className="space-y-4 sm:space-y-6 text-gray-400 font-normal text-sm">
                 ...
                 {!categoriesLoading && categories.length === 0 && (
                   <li><Link to="/user/home" className="hover:text-white transition-all">All Services</Link></li>
                 )}
              </ul>
            </div>
            ...
            <div className="flex flex-col items-center lg:items-start text-nowrap">
              ...
              <ul className="space-y-4 sm:space-y-6 text-gray-400 font-normal text-sm">
                 <li>Email: <a href={`mailto:${settings?.supportEmail || 'support@HomeBuddy24.in'}`} className="hover:text-white transition-all">{settings?.supportEmail || 'support@HomeBuddy24.in'}</a></li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 sm:gap-10 text-gray-500 font-normal text-[8px] sm:text-[10px] text-center whitespace-nowrap">
            <p>© {new Date().getFullYear()} {settings?.companyName || 'HomeBuddy24 Technologies'}. Proudly Indore 🇮🇳</p>
          </div>
        </div>
      </footer>
    </div>
