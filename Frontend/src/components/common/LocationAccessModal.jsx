  ...
  const getContent = () => {
    if (locationDisabled) {
      return {
        ...
        subtitle: "Please turn on your GPS to continue using HomeBuddy24 features.",
        icon: FiSettings
      };
    }
    return {
      title: "ALLOW GPS LOCATION",
      subtitle: "HomeBuddy24 needs your location to show available services and vendors near you.",
      icon: FiNavigation
    };
  };
